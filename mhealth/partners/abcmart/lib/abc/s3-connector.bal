...
configurable string inputBucket = "m-abc-edi";
configurable string processedBucket = "m-enroll";
configurable string failedBucket = "m-comcast-edi";
configurable decimal pollingInterval = 5000;

configurable string schemaURL = "https://api.github.com/repos/chathurace/demo/contents/mhealth/partners/abcmart/schema";
configurable string schemaAccessToken = ?;

configurable string applicationEndpoint = "http://localhost:9090";
